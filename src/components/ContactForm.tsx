...
export default function ContactForm() {
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const whatsappNumber = "918601387883";

    const whatsappMessage = `
Hello Baby Art Academy,

I would like to know more about your Mehndi Course.
...
Thank you.
  ...
  if (status === "success") {
    return (
      <div className="rounded-2xl border border-mehndi-100 bg-mehndi-50 p-6 text-center">
        <p className="font-display text-lg text-mehndi-800">
          WhatsApp opened successfully
        </p>

        <p className="mt-2 font-body text-[14.5px] text-charcoal-light">
          Your message is ready in WhatsApp. Please press Send to contact us.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div>
        <label
          htmlFor="name"
          className="font-body text-[13.5px] font-medium text-charcoal"
        >
          Name
        </label>
      ...
      <button
        type="submit"
        className="inline-flex items-center justify-center rounded-full bg-mehndi-700 px-6 py-3 font-body text-[15px] font-medium text-ivory transition-colors hover:bg-mehndi-800"
      >
